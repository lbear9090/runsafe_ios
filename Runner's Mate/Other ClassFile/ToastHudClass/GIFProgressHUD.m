...
- (void)setupContainerView
{
 ...
 //   CGFloat detailTitleLabelHeight = CGRectGetHeight(_detailTitleLabel.frame);
    ...
    CGFloat detailTitleLabelHeight = [self heightForText:_detailTitleLabel.text];
...
- (CGFloat)heightForText:(NSString *)bodyText
{
    ...
    CGSize maxsize=CGSizeMake(_detailTitleLabel.frame.size.width-5,MAXFLOAT);
    CGRect labelSize = [_detailTitleLabel.text boundingRectWithSize:maxsize options:
                        NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:_detailTitleLabel.font} context:nil];
