...
- (void)layoutSubviews
{
 ...
 //   [self.imageView setFrame:CGRectMake( self.imageView.frame.origin.x, self.imageView.frame.origin.y -15, self.imageView.frame.size.width, self.imageView.frame.size.height)];
    ...
    [self.titleLabel setFrame:CGRectMake( self.titleLabel.frame.origin.x, self.titleLabel.frame.origin.y+2, self.titleLabel.frame.size.width, self.titleLabel.frame.size.height+8)];
